...
import aves1 from '../../../assets/aves-1.jpg';
import aves2 from '../../../assets/aves-2.jpg';
import aves3 from '../../../assets/aves-3.jpg';
import gredos1 from '../../../assets/gredos-1.jpg';
import gredos2 from '../../../assets/gredos-2.jpg';
import gredos3 from '../../../assets/gredos-3.jpg';
import nava1 from '../../../assets/nava-1.jpg';
import nava2 from '../../../assets/nava-2.jpg';
import nava3 from '../../../assets/nava-3.jpg';
import prismaticos from '../../../assets/prismaticos.jpg';
    ...
    <section className="home">
      ...
      <article className="welcome">
        ...
        <div className="image-gallery">
          <div className="image-card">
            <img src={aves1} alt="Ave 1 - Navarrevisca" />
          </div>
          <div className="image-card">
            <img src={aves2} alt="Ave 2 - Navarrevisca" />
          </div>
          <div className="image-card">
            <img src={aves3} alt="Ave 3 - Navarrevisca" />
          </div>
        </div>
      </article>
      ...
      <article className="locations">
        ...
        <section className="image-gallery">
          <div className="image-card">
            <img src={gredos1} alt="Gredos 1 - Paisaje" />
          </div>
          <div className="image-card">
            <img src={gredos2} alt="Gredos 2 - Paisaje" />
          </div>
          <div className="image-card">
            <img src={gredos3} alt="Gredos 3 - Paisaje" />
          </div>
        </section>
        ...
        <div className="image-gallery">
          <div className="image-card">
            <img src={nava1} alt="Navarrevisca 1 - Pueblo" />
          </div>
          <div className="image-card">
            <img src={nava2} alt="Navarrevisca 2 - Paisaje" />
          </div>
          <div className="image-card">
            <img src={nava3} alt="Navarrevisca 3 - Detalle" />
          </div>
        </div>
      ...
      <article className="content-explore">
        ...
        <div className="featured-image">
          <div className="image-card featured">
            <img src={prismaticos} alt="Observación de aves con prismáticos" />
          </div>
        </div>
      </article>
