...
class AdminService {
  ...
  async createBird(birdData) {
    try {
      ...
      console.error('Admin Service Error en createBird:', error);
  ...
  async updateBird(birdId, updateData) {
    try {
      console.log(`Admin Service: Actualizando ave ID ${birdId}...`);
      ...
      console.error(`Admin Service Error en updateBird(${birdId}):`, error);
      throw error;
    }
  }
  ...
  async deleteBird(birdId) {
    try {
      console.log(`Admin Service: Eliminando ave ID ${birdId}...`);
      ...
      console.error(`Admin Service Error en deleteBird(${birdId}):`, error);
      throw error;
    }
  }
  ...
  async birdExists(birdId) {
    try {
      ...
      console.error(`Admin Service Error en birdExists(${birdId}):`, error);
      return false;
    }
  }
}
